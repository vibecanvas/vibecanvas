...
export const ALLOWED_STATE_TRANSITIONS: Record<CONNECTION_STATE, CONNECTION_STATE[]> = {
  ...
  [CONNECTION_STATE.RETRYING]: [CONNECTION_STATE.CONNECTED, CONNECTION_STATE.FAILED_TO_CONNECT, CONNECTION_STATE.READY],
  [CONNECTION_STATE.READY]: [CONNECTION_STATE.PROCESS_REQUEST, CONNECTION_STATE.STREAMING],
  [CONNECTION_STATE.STREAMING]: [CONNECTION_STATE.FINISHED, CONNECTION_STATE.ERROR, CONNECTION_STATE.RETRYING],
  [CONNECTION_STATE.REQUESTING_HUMAN_INPUT]: [CONNECTION_STATE.PROCESS_REQUEST],
  [CONNECTION_STATE.PROCESS_REQUEST]: [CONNECTION_STATE.STREAMING, CONNECTION_STATE.ERROR, CONNECTION_STATE.FINISHED],
  [CONNECTION_STATE.FINISHED]: [CONNECTION_STATE.READY],
  [CONNECTION_STATE.ERROR]: [CONNECTION_STATE.READY],
}
