...
type TChatPathPickerDialogProps = {
  open: boolean
...
export function ChatPathPickerDialog(props: TChatPathPickerDialogProps) {
  ...
  return (
    <Dialog open={props.open} onOpenChange={props.onOpenChange}>
      <Dialog.Portal>
        ...
        >
          <Dialog.Title class="font-display text-base text-foreground mb-1 shrink-0">
            Select Chat Folder
          </Dialog.Title>
          <Dialog.Description class="text-xs text-warning bg-warning/10 border border-warning/40 px-2 py-1.5 mb-3 shrink-0">
            Path change starts a new session.
          </Dialog.Description>
