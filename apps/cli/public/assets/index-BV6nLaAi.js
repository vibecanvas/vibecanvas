import { P as st, D as Q, E as v, T as it, F as Ee, s as Ie, G as H, H as ot, p as m, L as fe, J as at, K as lt, M as ht, z as X, O as P, Q as z, R as ft, U as ut, V as dt, W as pt, X as ct, w as Me, r as mt, Y as gt, Z as kt, _ as ue, $ as Lt, __tla as __tla_0 } from "./index-Bd9yMaDE.js";
import { html as bt, htmlCompletionSource as wt, __tla as __tla_1 } from "./index-DKG_bs0C.js";
import { __tla as __tla_2 } from "./index-J5lwC7zI.js";
import { __tla as __tla_3 } from "./index-DOtO3MEE.js";
import { __tla as __tla_4 } from "./index-DWAC_B0U.js";
let Kt, nr, er, Wt, cr, sr, q, lr;
let __tla = Promise.all([
    ...
    class _ {
        ...
        constructor(e, r, n, s, i, o, a){
            this.type = e, this.value = r, this.from = n, this.hash = s, this.end = i, this.children = o, this.positions = a, this.hashProp = [
                [
                    v.contextHash,
                    s
                ]
    ...
    const $ = {
        ...
        IndentedCode (t, e) {
            ...
            for(x(o, s, i); t.nextLine() && e.depth >= t.stack.length;)if (e.pos == e.text.length) {
        ...
        FencedCode (t, e) {
            let r = Pe(e);
            if (r < 0) return !1;
            let n = t.lineStart + e.pos, s = e.next, i = r - e.pos, o = e.skipSpace(r), a = pe(e.text, e.text.length, o), l = [
                k(u.CodeMark, n, n + i)
            ];
...
` + r.scrub(), i = this.advance(s);
    ...
    class It {
        constructor(e, r, n, s){
            this.parser = e, this.input = r, this.ranges = s, this.line = new Ct, this.atEnd = !1, this.reusePlaceholders = new Map, this.stoppedAt = null, this.rangeI = 0, this.to = s[s.length - 1].to, this.lineStart = this.absoluteLineStart = this.absoluteLineEnd = s[0].from, this.block = _.create(u.Document, 0, this.lineStart, 0, 0), this.stack = [
                this.block
            ], this.fragments = n.length ? new Pt(n, r) : null, this.readLine();
        }
        get parsedPos() {
        ...
        advance() {
            ...
            e: for(;;){
                for (let n of this.parser.blockParsers)if (n) {
                    let s = n(this, e);
                    if (s != !1) {
                        if (s == !0) return null;
                        e.forward();
            ...
            for (let n of this.parser.leafBlockParsers)if (n) {
                let s = n(this, r);
                s && r.parsers.push(s);
            }
...
`);
    ...
    class Z extends st {
        constructor(e, r, n, s, i, o, a, l, h){
            super(), this.nodeSet = e, this.blockParsers = r, this.leafBlockParsers = n, this.blockNames = s, this.endLeafBlock = i, this.skipContextMarkup = o, this.inlineParsers = a, this.inlineNames = l, this.wrappers = h, this.nodeTypes = Object.create(null);
        ...
        configure(e) {
            ...
            if (R(r.defineNodes)) {
                ...
                for (let L of r.defineNodes){
                    let { name: g, block: B, composite: w, style: S } = typeof L == "string" ? {
                        name: L
                    } : L;
                    ...
                    let b = d.length, E = w ? [
                        "Block",
                        "BlockContext"
                    ] : B ? b >= u.ATXHeading1 && b <= u.SetextHeading2 ? [
                        "Block",
                        "LeafBlock",
                        "Heading"
                    ] : [
            ...
            if (R(r.props) && (n = n.extend(...r.props)), R(r.remove)) for (let d of r.remove){
                let c = this.blockNames.indexOf(d), L = this.inlineNames.indexOf(d);
                c > -1 && (i[c] = o[c] = void 0), L > -1 && (l[L] = void 0);
            }
            if (R(r.parseBlock)) for (let d of r.parseBlock){
            ...
            if (R(r.parseInline)) for (let d of r.parseInline){
    ...
    for(let t = 1, e; e = u[t]; t++)Xe[t] = Q.define({
        id: t,
        name: e,
        props: t >= u.Escape ? [] : [
            [
    ...
    const G = {
        ...
        InlineCode (t, e, r) {
            ...
            let s = n - r, i = 0;
            for(; n < t.end; n++)if (t.char(n) == 96) {
                if (i++, i == s && t.char(n + 1) != 96) return t.append(k(u.InlineCode, r, n + 1, [
                    k(u.CodeMark, r, r + s),
        ...
        HTMLTag (t, e, r) {
            ...
            if (s) return t.append(k(u.Autolink, r, r + 1 + s[0].length, [
                k(u.LinkMark, r, r + 1),
        ...
        LinkEnd (t, e, r) {
            ...
            for(let n = t.parts.length - 1; n >= 0; n--){
                ...
                if (s instanceof C && (s.type == M || s.type == j)) {
                    if (!s.side || t.skipSpace(s.to) == r && !/[(\[]/.test(t.slice(r + 1, r + 2))) return t.parts[n] = null, -1;
                    let i = t.takeContent(n), o = t.parts[n] = Mt(t, i, s.type == M ? u.Link : u.Image, s.from, r + 1);
                    if (s.type == M) for(let a = 0; a < n; a++){
                        let l = t.parts[a];
    ...
    class ae {
        ...
        resolveMarkers(e) {
            for(let n = e; n < this.parts.length; n++){
                ...
                for(; l >= e; l--){
                    let g = this.parts[l];
                    if (g instanceof C && g.side & 1 && g.type == s.type && !(i && (s.side & 1 || g.side & 2) && (g.to - g.from + o) % 3 == 0 && ((g.to - g.from) % 3 || o % 3))) {
                        a = g;
                        break;
                    }
                }
    ...
    function re(t, e) {
        ...
        for (let s of e){
            ...
            if (n < r.length && r[n].from < s.from) {
                let i = r[n];
                i instanceof D && (r[n] = new D(i.type, i.from, i.to, re(i.children, [
                    s
                ])));
            } else r.splice(n++, 0, s);
        }
...
`;)i--;
        ...
        takeNodes(e) {
            ...
            for(;;){
                ...
                if (r.type.is("Block") && (Ht.indexOf(r.type.id) < 0 ? (o = r.to - n, a = e.block.children.length) : (o = l, a = h), l = r.to - n, h = e.block.children.length), !r.nextSibling()) break;
            }
        ...
        return {
            wrap: ot((s, i)=>{
                ...
                if (e && (o == u.CodeBlock || o == u.FencedCode)) {
                    ...
                    if (l) return {
                        parser: l,
                        overlay: (h)=>h.type.id == u.CodeText,
                        bracketed: o == u.FencedCode
                    };
                } else if (r && (o == u.HTMLBlock || o == u.HTMLTag || o == u.CommentBlock)) return {
                    parser: r,
                    overlay: yt(s.node, s.from, s.to)
                };
                return null;
            })
        };
    ...
    }), Ye = new v, We = Nt.configure({
        props: [
            Me.add((t)=>!t.is("Block") || t.is("Document") || ne(t) != null || Zt(t) ? void 0 : (e, r)=>({
                        from: r.doc.lineAt(e.from).to,
                        to: e.to
                    })),
            Ye.add(ne),
            mt.add({
    ...
    function Yt(t, e) {
        return (r)=>{
            if (r && t) {
                let n = null;
                if (r = /\S*/.exec(r)[0], typeof t == "function" ? n = t(r) : n = ue.matchLanguageName(t, r, !0), n instanceof ue) return n.support ? n.support.language.parser : Lt.getSkippingParser(n.load());
    ...
    function et(t, e) {
        ...
        for(let s = r.length - 1; s >= 0; s--){
            ...
            if (i.name == "Blockquote" && (o = /^ *>( ?)/.exec(a.text.slice(l)))) n.push(new K(i, l, l + o[0].length, "", o[1], ">", null));
    ...
    Wt = (t = {})=>({ state: e, dispatch: r })=>{
            let n = X(e), { doc: s } = e, i = null, o = e.changeByRange((a)=>{
                if (!a.empty || !q.isActiveAt(e, a.from, -1) && !q.isActiveAt(e, a.from, 1)) return i = {
                    range: a
                };
                ...
                let p = f[f.length - 1];
                if (p.to - p.spaceAfter.length > l - h.from) return i = {
                    range: a
                };
                ...
                if (p.item && d) {
                    ...
                    if (w.to >= l || S && S.to < l || h.from > 0 && !/[^\s>]/.test(s.lineAt(h.from - 1).text) || t.nonTightLists === !1) {
                        ...
                        return p.node.name == "OrderedList" && J(p.item, s, y, -2), b && b.node.name == "OrderedList" && J(b.item, s, y), {
                            range: P.cursor(E + I.length),
                            changes: y
                        };
                    } else {
                        let b = Be(f, e, h);
                ...
                if (!L || /^[\s\d.)\-+*>]*/.exec(h.text)[0].length >= p.to) for(let w = 0, S = f.length - 1; w <= S; w++)g += w == S && !L ? f[w].marker(s, 1) : f[w].blank(w < S ? z(h.text, 4, f[w + 1].from) - g.length : null);
                let B = l;
                for(; B > h.from && /\s/.test(h.text.charAt(B - h.from - 1));)B--;
                return g = he(g, e), tr(p.node, e.doc) && (g = Be(f, e, h) + e.lineBreak + g), c.push({
                    from: B,
                    to: l,
                    insert: e.lineBreak + g
                }), {
                    range: P.cursor(B + g.length + 1),
                    changes: c
                };
            });
            return i ? !1 : (r(e.update(o, {
                scrollIntoView: !0,
                userEvent: "input"
            })), !0);
        };
    ...
    function Be(t, e, r) {
        let n = "";
        for(let s = 0, i = t.length - 2; s <= i; s++)n += t[s].blank(s < i ? z(r.text, 4, t[s + 1].from) - n.length : null, s < i);
        return he(n, e);
    }
    function rr(t, e) {
        let r = t.resolveInner(e, -1), n = e;
        xe(r) && (n = r.from, r = r.parent);
        for(let s; s = r.childBefore(n);)if (xe(s)) n = s.from;
        else if (s.name == "OrderedList" || s.name == "BulletList") r = s.lastChild, n = r.to;
        else break;
        return r;
    }
    let rt;
    nr = ({ state: t, dispatch: e })=>{
        let r = X(t), n = null, s = t.changeByRange((i)=>{
            ...
            if (i.empty && q.isActiveAt(t, i.from)) {
                ...
                if (h.length) {
                    ...
                    if (o - l.from > p && !/\S/.test(l.text.slice(p, o - l.from))) return {
    ...
    cr = function(t = {}) {
        ...
        l.push(Rt({
            codeParser: p,
            htmlParser: a.language.parser
        })), n && h.push(at.high(lt.of(sr)));
        let d = le(s.configure(l));
        return i && h.push(d.data.of({
            autocomplete: ir
        })), new fe(d, h);
    };
    function ir(t) {
        ...
        for(; s && !s.type.isTop;){
            if (s.name == "CodeBlock" || s.name == "FencedCode" || s.name == "ProcessingInstructionBlock" || s.name == "CommentBlock" || s.name == "Link" || s.name == "Image") return null;
            s = s.parent;
        }
        return {
            from: r - n[0].length,
    ...
    function or() {
        if (Y) return Y;
        let t = wt(new pt(ct.create({
            extensions: rt
        }), 0, !0));
        return Y = t ? t.options : [];
    }
    let ar;
    ar = /code|horizontalrule|html|link|comment|processing|escape|entity|image|mark|url/i;
    lr = kt.domEventHandlers({
        paste: (t, e)=>{
            var r;
            let { main: n } = e.state.selection;
            if (n.empty) return !1;
            let s = (r = t.clipboardData) === null || r === void 0 ? void 0 : r.getData("text/plain");
            if (!s || !/^(https?:\/\/|mailto:|xmpp:|www\.)/.test(s) || (/^www\./.test(s) && (s = "https://" + s), !q.isActiveAt(e.state, n.from, 1))) return !1;
            let i = X(e.state), o = !1;
            return i.iterate({
                from: n.from,
                to: n.to,
...
export { Kt as commonmarkLanguage, nr as deleteMarkupBackward, er as insertNewlineContinueMarkup, Wt as insertNewlineContinueMarkupCommand, cr as markdown, sr as markdownKeymap, q as markdownLanguage, lr as pasteURLAsLink, __tla };
