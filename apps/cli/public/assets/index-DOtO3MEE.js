import { L as k, E as $, a as z, __tla as __tla_0 } from "./index-J5lwC7zI.js";
import { s as R, p as t, L as Y, q as W, r as Z, v as x, w as G, x as _, z as V, N as E, I as U, __tla as __tla_1 } from "./index-Bd9yMaDE.js";
let Pe, ye, f, ge;
let __tla = Promise.all([
    ...
    const T = 135, m = 1, q = 136, C = 137, P = 2, N = 138, F = 3, I = 4, X = [
        ...
        8287,
        12288
    ], D = 58, B = 40, b = 95, K = 91, c = 45, L = 46, A = 35, J = 37, H = 38, M = 92, ee = 10, Oe = 42;
    function Q(e) {
    ...
    const v = (e, r, i)=>(O, a)=>{
            for(let o = !1, l = 0, n = 0;; n++){
                let { next: s } = O;
                if (Q(s) || s == c || s == b || o && j(s)) !o && (s != c || n > 0) && (o = !0), l === n && s == c && l++, O.advance();
        ...
        if (X.includes(e.peek(-1))) {
            let { next: r } = e;
            (Q(r) || r == b || r == A || r == L || r == Oe || r == K || r == D && Q(e.peek(1)) || r == c || r == H) && e.acceptToken(T);
        }
    }), oe = new $((e)=>{
        if (!X.includes(e.peek(-1))) {
            let { next: r } = e;
        ...
        tokenizers: [
            ...
            3,
            4,
            new z("m~RRYZ[z{a~~g~aO$T~~dP!P!Qg~lO$U~~", 28, 142)
        ],
        topRules: {
            StyleSheet: [
                0,
    ...
    function u() {
        if (!p && typeof document == "object" && document.body) {
            let { style: e } = document.body, r = [], i = new Set;
            for(let O in e)O != "cssText" && O != "cssFloat" && typeof e[O] == "string" && (/[A-Z]/.test(O) && (O = O.replace(/[A-Z]/g, (a)=>"-" + a.toLowerCase())), i.has(O) || (r.push(O), i.add(O)));
            p = r.sort().map((O)=>({
                    type: "property",
                    label: O,
                    apply: O + ": "
    ...
    function je(e, r) {
        ...
        return O?.name != "Callee" ? !1 : r.sliceString(O.from, O.to) == "var";
    }
    const h = new E, me = [
        "Declaration"
    ];
    ...
    function w(e, r, i) {
        if (r.to - r.from > 4096) {
            let O = h.get(r);
            if (O) return O;
            let a = [], o = new Set, l = r.cursor(U.IncludeAnonymous);
            if (l.firstChild()) do for (let n of w(e, l.node, i))o.has(n.label) || (o.add(n.label), a.push(n));
            while (l.nextSibling());
            return h.set(r, a), a;
        } else {
            let O = [], a = new Set;
            return r.cursor().iterate((o)=>{
                var l;
                if (i(o) && o.matchContext(me) && ((l = o.node.nextSibling) === null || l === void 0 ? void 0 : l.name) == ":") {
                    let n = e.sliceString(o.from, o.to);
                    a.has(n) || (a.add(n), O.push({
                        label: n,
                        type: "variable"
                    }));
                }
    ...
    ge = (e)=>(r)=>{
            let { state: i, pos: O } = r, a = V(i).resolveInner(O, -1), o = a.type.isError && a.from == a.to - 1 && i.doc.sliceString(a.from, a.to) == "-";
            ...
            if (e(a) || (r.explicit || o) && je(a, i.doc)) return {
                from: e(a) || o ? a.from : O,
                options: w(i.doc, Se(a), e),
                validFor: ue
            };
            if (a.name == "TagName") {
                for(let { parent: s } = a; s; s = s.parent)if (s.name == "Block") return {
                    from: a.from,
                    options: u(),
                    validFor: d
                };
    ...
    Pe = function() {
        return new Y(f, f.data.of({
            autocomplete: ye
        }));
    };
});
export { Pe as css, ye as cssCompletionSource, f as cssLanguage, ge as defineCSSCompletionSource, __tla };
