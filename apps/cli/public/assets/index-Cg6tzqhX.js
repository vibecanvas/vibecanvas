import { L as V, E as i, C as _, __tla as __tla_0 } from "./index-J5lwC7zI.js";
import { s as w, p as P, L as Z, q as L, r as B, y as v, w as E, x as M, __tla as __tla_1 } from "./index-Bd9yMaDE.js";
let $O, bO;
let __tla = Promise.all([
    ...
    const f = 63, q = 64, j = 1, A = 2, U = 3, H = 4, W = 5, N = 6, I = 7, y = 65, u = 66, F = 8, K = 9, J = 10, OO = 11, eO = 12, Y = 13, aO = 19, rO = 20, QO = 29, PO = 33, tO = 34, oO = 47, nO = 0, $ = 1, b = 2, d = 3, x = 4;
    class s {
        constructor(e, a, r){
    ...
    const sO = new _({
        ...
        shift (O, e, a, r) {
            if (e == U) return new s(O, X(r, r.pos), $);
            if (e == y || e == W) return new s(O, X(r, r.pos), b);
            if (e == f) return O.parent;
            if (e == aO || e == PO) return new s(O, 0, d);
            if (e == Y && O.type == x) return O.parent;
            if (e == oO) {
                let t = /[1-9]/.exec(r.read(r.pos, a.pos));
                if (t) return new s(O, O.depth + +t[0], x);
            }
            return O;
        },
        hash (O) {
    ...
    const lO = new i((O, e)=>{
        if (O.next == -1 && e.canShift(q)) return O.acceptToken(q);
        let a = O.peek(-1);
        if ((o(a) || a < 0) && e.context.type != d) {
            if (c(O, 45)) if (e.canShift(f)) O.acceptToken(f);
            else return O.acceptToken(j, 3);
            if (c(O, 46)) if (e.canShift(f)) O.acceptToken(f);
            else return O.acceptToken(A, 3);
            let r = 0;
            for(; O.next == 32;)r++, O.advance();
            (r < e.context.depth || r == e.context.depth && e.context.type == $ && (O.next != 45 || !l(O.peek(1)))) && O.next != -1 && !o(O.next) && O.next != 35 && O.acceptToken(f, -r);
        }
    }, {
        contextual: !0
    }), fO = new i((O, e)=>{
        ...
        if (O.next == 45) O.advance(), l(O.next) && O.acceptToken(e.context.type == $ && e.context.depth == X(O, O.pos - 1) ? H : U);
        else if (O.next == 63) O.advance(), l(O.next) && O.acceptToken(e.context.type == b && e.context.depth == X(O, O.pos - 1) ? N : W);
        else {
            let a = O.pos;
            for(;;)if (g(O.next)) {
                if (O.pos == a) return;
                O.advance();
            } else if (O.next == 33) z(O);
            else if (O.next == 38) m(O);
            else if (O.next == 42) {
                m(O);
                break;
    ...
    function T(O, e) {
        ...
        for(O.advance();;){
            let Q = O.next;
            if (Q < 0) break;
            if (O.advance(), Q == a) if (Q == 39) if (O.next == 39) O.advance();
            else break;
            else break;
            else if (Q == 92 && a == 34) O.next >= 0 && O.advance();
            else if (o(Q)) {
                if (e) return !1;
                r = !0;
            } else if (e && O.pos >= t + 1024) return !1;
        }
        return !r;
    }
    function XO(O) {
        for(let e = [], a = O.pos + 1024;;)if (O.next == 91 || O.next == 123) e.push(O.next), O.advance();
        else if (O.next == 39 || O.next == 34) {
            if (!T(O, !0)) return !1;
            ...
            if (O.next < 0 || O.pos > a || o(O.next)) return !1;
            O.advance();
        }
    }
    ...
    function G(O, e, a, r) {
        ...
        for(;;){
            ...
            if (!(Q >= 0 && (Q == 58 ? k(O.peek(n + 1), a) : Q == 35 ? O.peek(n - 1) != 32 : k(Q, a))) || !a && R <= r || R == 0 && !a && (c(O, 45, n) || c(O, 46, n))) break;
            if (e && S(Q) == "f") return !1;
    ...
    let RO, SO, iO, kO;
    RO = new i((O, e)=>{
        if (O.next == 33) z(O), O.acceptToken(eO);
    ...
    SO = new i((O, e)=>{
        let a = e.context.type == x ? e.context.depth : -1, r = O.pos;
        O: for(;;){
            let t = 0, Q = O.next;
            for(; Q == 32;)Q = O.peek(++t);
            if (!t && (c(O, 45, t) || c(O, 46, t)) || !o(Q) && (a < 0 && (a = Math.max(e.context.depth + 1, t)), t < a)) break;
            for(;;){
                if (O.next < 0) break O;
                let n = o(O.next);
...
export { $O as yaml, bO as yamlLanguage, __tla };
