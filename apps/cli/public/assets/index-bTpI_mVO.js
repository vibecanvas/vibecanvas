import { L as G, E as A, C as N, __tla as __tla_0 } from "./index-J5lwC7zI.js";
import { s as I, p, L as Y, q as j, r as U, w as Z, a0 as B, z as k, Z as D, O as M, __tla as __tla_1 } from "./index-Bd9yMaDE.js";
let fe, pe, xe, w;
let __tla = Promise.all([
    ...
    function y(e, t) {
        return new A((o)=>{
            ...
            e: for(; !(o.next < 0); o.advance(), O++)if (o.next == r) {
    ...
    function ge(e, t) {
        ...
        for(let a = O; !r && a.parent; a = a.parent)(a.name == "OpenTag" || a.name == "CloseTag" || a.name == "SelfClosingTag" || a.name == "MismatchedCloseTag") && (r = a);
        if (r && (r.to > t || r.lastChild.type.isError)) {
            let a = r.parent;
            if (O.name == "TagName") return r.name == "CloseTag" || r.name == "MismatchedCloseTag" ? {
                type: "closeTag",
                from: O.from,
                context: a
            } : {
            ...
            if (O.name == "AttributeName") return {
                type: "attrName",
                from: O.from,
                context: r
            };
            if (O.name == "AttributeValue") return {
                type: "attrValue",
                from: O.from,
                context: r
            };
            let s = O == r || O.name == "Attribute" ? O.childBefore(t) : O;
            return s?.name == "StartTag" ? {
                type: "openTag",
                from: t,
                context: C(a)
            } : s?.name == "StartCloseTag" && s.to <= t ? {
                type: "closeTag",
                from: t,
                context: a
            } : s?.name == "Is" ? {
        ...
        } else if (O.name == "StartCloseTag") return {
            type: "closeTag",
            from: t,
            context: O.parent
        };
        ...
        return O.name == "Element" || O.name == "Text" || O.name == "Document" ? {
            type: "tag",
            from: t,
            context: O.name == "Element" ? O : C(O)
        } : null;
    }
    class ue {
        constructor(t, o, O){
            this.attrs = o, this.attrValues = O, this.children = [], this.name = t.name, this.completion = Object.assign(Object.assign({
                type: "type"
            }, t.completion || {}), {
                label: this.name
                ...
                label: this.name + ">"
            }), this.text = t.textContent ? t.textContent.map((r)=>({
                    label: r,
                    type: "text"
                })) : [];
        }
    ...
    pe = function(e, t) {
        let o = [], O = [], r = Object.create(null);
        for (let n of t){
            let $ = E(n);
            o.push($), n.global && O.push($), n.values && (r[n.name] = n.values.map(R));
        }
        let a = [], s = [], f = Object.create(null);
        for (let n of e){
            let $ = O, c = r;
            n.attributes && ($ = $.concat(n.attributes.map((l)=>typeof l == "string" ? o.find((d)=>d.label == l) || {
                    label: l,
                    type: "property"
        ...
        return (n)=>{
            ...
            if (l == "openTag") {
                ...
                i && (!q || q.name != "CloseTag" || T(c, q) != i) && g.push(m ? m.closeCompletion : {
                    label: "</" + i + ">",
                    type: "type",
                    boost: 2
                });
                ...
                Z.add({
                    Element (e) {
                        ...
                        return !t || t.name != "OpenTag" ? null : {
                            from: t.to,
                            to: o.name == "CloseTag" ? o.from : e.to
                        };
                    }
                }),
                B.add({
    ...
    xe = function(e = {}) {
        ...
        return e.autoCloseTags !== !1 && t.push(fe), new Y(w, t);
    };
    ...
    fe = D.inputHandler.of((e, t, o, O, r)=>{
...
export { fe as autoCloseTags, pe as completeFromSchema, xe as xml, w as xmlLanguage, __tla };
