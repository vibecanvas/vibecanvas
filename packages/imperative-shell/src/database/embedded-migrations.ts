...
import migration8 from '../../database-migrations/meta/0000_snapshot.json' with { type: "file" };
import migration9 from '../../database-migrations/meta/0001_snapshot.json' with { type: "file" };
import migration10 from '../../database-migrations/meta/0002_snapshot.json' with { type: "file" };
import migration11 from '../../database-migrations/meta/0003_snapshot.json' with { type: "file" };
import migration12 from '../../database-migrations/meta/0004_snapshot.json' with { type: "file" };
import migration13 from '../../database-migrations/meta/0005_snapshot.json' with { type: "file" };
import migration14 from '../../database-migrations/meta/0006_snapshot.json' with { type: "file" };
import migration15 from '../../database-migrations/meta/0007_snapshot.json' with { type: "file" };
import migration16 from '../../database-migrations/meta/_journal.json' with { type: "file" };
...
const embeddedMigrationPaths = new Map<string, string>([
  ...
  ["meta/0000_snapshot.json", migration8],
  ["meta/0001_snapshot.json", migration9],
  ["meta/0002_snapshot.json", migration10],
  ["meta/0003_snapshot.json", migration11],
  ["meta/0004_snapshot.json", migration12],
  ["meta/0005_snapshot.json", migration13],
  ["meta/0006_snapshot.json", migration14],
  ["meta/0007_snapshot.json", migration15],
  ["meta/_journal.json", migration16],
]);
