...
describe("TextPlugin – resize", () => {
  ...
  test("toTElement bakes scaleX/scaleY into width/height", () => {
    ...
    const data = el.data as import("@vibecanvas/service-automerge/types/canvas-doc").TTextData;
...
describe("TextPlugin – CRDT persistence", () => {
  test("entering edit mode and committing text patches CRDT with correct TTextData", async () => {
    ...
    const data = docHandle.doc().elements["crdt-text-1"].data as import("@vibecanvas/service-automerge/types/canvas-doc").TTextData;
  ...
  test("multiline text is persisted correctly to CRDT", async () => {
    ...
    const data = docHandle.doc().elements["crdt-nl-1"].data as import("@vibecanvas/service-automerge/types/canvas-doc").TTextData;
