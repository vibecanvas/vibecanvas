...
import migration9 from '../database-migrations/0009_graceful_the_phantom.sql' with { type: "file" };
...
import migration19 from '../database-migrations/meta/0009_snapshot.json' with { type: "file" };
import migration20 from '../database-migrations/meta/_journal.json' with { type: "file" };
...
const embeddedMigrationPaths = new Map<string, string>([
  ...
  ["0009_graceful_the_phantom.sql", migration9],
  ...
  ["meta/0009_snapshot.json", migration19],
  ["meta/_journal.json", migration20],
]);
